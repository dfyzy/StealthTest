Shader "UI/S_HorizontalFill"
{
	Properties
	{
		...
		_FillFactor ("Fill Factor", Float) = 0.75
		_FillColor ("Fill Color", Float) = 0.35
	}
	SubShader
	{
		Tags
	...
	Pass
	{
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				half4 color = half4(
					texColor.rbg * IN.color.rgb,
					texColor.a*lerp(IN.color.a, _FillColor, ceil(IN.texcoord.y - _FillFactor))
				);
